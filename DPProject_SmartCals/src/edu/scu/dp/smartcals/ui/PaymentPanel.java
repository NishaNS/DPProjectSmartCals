...
public class PaymentPanel extends javax.swing.JPanel {
    ...
    private void btnCashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCashActionPerformed
    	lblCoinUnsucess.setVisible(false);
    	//lblDenominations.setText("Denominations: 10$,20$ or 50$");
    	parentView.vmDetailsView.lblDisplay.setText("SmartCals Vending Machine");
    	parentView.vmDetailsView.lblCoinDispense.setText("Dispense Coin:");
    	...
    	if((txtAmtPayable.getText().isEmpty()) || (txtOneDollarCash.getText().isEmpty()) || (txtFiveDollar.getText().isEmpty()) || (txtTenDollar.getText().isEmpty()))
    	{
    		...
    		p = pc.makePayment("Cash",amtPayable);
    		p.setTotValue(oneDollar,fiveDollar,tenDollar);
    		}
    		else{
    			p = pc.makePayment("NullCash",0);
    		}
    	    ...
    	    if(p.getPaymentStatus()){
    	    	try {
					parentView.vmController.smctDao.loadSmartCard(parentView.vmController.smct.getSmartCard(),p.getAmtPayable());
				} catch (SQLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
                parentView.vmDetailsView.scPanel.payPan.setVisible(false);
    	     	parentView.vmDetailsView.lblDisplay.setText("Payment Successful");
    	     	parentView.vmDetailsView.lblCashDispense.setText("Dispense Cash:" + Double.toString(p.getAmtToReturn()));	
    	    }
    	    else{
    ...
    private void btnCoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCoinActionPerformed
    	...
    	if((txtAmtPayable.getText().isEmpty()) || (txtQuarters.getText().isEmpty()) || (txtHalfDollar.getText().isEmpty()) || (txtOneDollar.getText().isEmpty()))
    	{
    	    ...
    	    if(p.getPaymentStatus()){
                ...
                parentView.getVMDetails_View().getSCPanel().payPan.setVisible(false);
